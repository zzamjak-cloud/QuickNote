...
| 멘션·링크 클릭 이동/Ctrl+클릭/뒤로가기/탭 닫기 | `navigation/overview.md` |
...
| 외부 보호 DB 행 배치·페이지네이션 로드 | `sync/external-protected-database-load.md` |
...
| 파일 | 내용 |
|------|------|
| `overview.md` | 멘션·페이지/블록 링크 클릭 이동, Ctrl+클릭 새 탭, 브라우저 뒤로가기(history), 헤더 "이전 페이지" 인앱 백스택, 탭 가운데클릭 닫기, 멘션 칩 스타일 |
