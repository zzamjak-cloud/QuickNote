...
export const blockDefinitions: BlockDefinition[] = [
  ...
  defineBlock({
    id: "dropdownMenu",
    title: "드롭다운 메뉴",
    nodeTypes: ["dropdownMenuBlock"],
    group: "interactive",
    dnd: movableLeafDnd,
    editor: { excludeFromUniqueId: true },
    toolbar: { kind: "none" },
    serialization: { schemaVersion: 1, stableType: "dropdownMenu" },
    slashTitles: ["드롭다운 메뉴"],
  }),
  defineBlock({
    id: "gallery",
    title: "갤러리",
    nodeTypes: ["galleryBlock"],
    group: "media",
    dnd: movableLeafDnd,
    editor: { excludeFromUniqueId: true },
    toolbar: { kind: "none" },
    serialization: { schemaVersion: 1, stableType: "gallery" },
    slashTitles: ["갤러리"],
  }),
  defineBlock({
    id: "table",
